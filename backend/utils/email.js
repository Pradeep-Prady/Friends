...
const sendEmail = async (options) => {
  const transport = {
    service: "gmail",
    auth: {
      user: "narikootamgallery@gmail.com",
      pass: "hzybynpobnnfarpc",
    },
  };
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; background-color: #ffffff;">
          ...
          <tr>
            <td style="padding: 20px 40px;">
              ...
              <p>We received a request to reset your password for your Narikootam account. If you did not initiate this request, please ignore this email.</p>
              ...
              <p>If you have any questions or need further assistance, please do not hesitate to contact our support team at <a href="mailto:narikootamgallery@gmail.com" style="color: #007bff;">Email</a>.</p>
              <p>Thank you,<br>The Narikootam Team</p>
            </td>
          </tr>
        </table>
